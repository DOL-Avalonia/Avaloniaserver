...
namespace DOL.GS.Keeps
{
    ...
    public class GameKeepHookPoint
    {
        ...
        private void ObjectDie(DOLEvent e, object sender, EventArgs arguments)
        {
            ...
            DBKeepHookPointItem item = DOLDB<DBKeepHookPointItem>.SelectObject(DB.Column("KeepID").IsEqualTo(Component.Keep.KeepID).And(DB.Column("ComponentID").IsEqualTo(Component.ID)).And(DB.Column("HookPointID").IsEqualTo(ID)));
            if (item != null)
            {
