		...
		public virtual bool PrivateMessageReceive(GamePlayer source, string str)
		{
			...
			else
			{
				Out.SendMessage(
					LanguageMgr.GetTranslation(
						Client.Account.Language,
						"GamePlayer.SendReceive.FalseLanguage",
						source.Name),
			...
			if (afkmessage != null)
			{
				...
				else
				{
					source.Out.SendMessage(
						LanguageMgr.GetTranslation(
							source.Client.Account.Language,
							"GamePlayer.SendReceive.AfkMessage",
							Name, afkmessage),
						eChatType.CT_Say,
					...
					else if (group != null && group.AutosplitLoot)
					{
						...
						if (eligibleMember != null)
						{
							...
							Message.SystemToOthers(
								...
								LanguageMgr.GetTranslation(
									Client.Account.Language,
									"GamePlayer.PickupObject.GroupMemberPicksUp",
									Name,
							...
							group.SendMessageToGroupMembers(
								LanguageMgr.GetTranslation(
									Client.Account.Language,
									"GamePlayer.PickupObject.Autosplit",
