...
namespace DOL.GS
{
    ...
    public class Salvage
    {
        ...
        public static int BeginWork(GamePlayer player, GameSiegeWeapon siegeWeapon)
        {
            ...
            bool error = false;
            DBCraftedItem recipe = DOLDB<DBCraftedItem>.SelectObject(DB.Column("Id_nb").IsEqualTo(siegeWeapon.ItemId));
            ...
            IList<DBCraftedXItem> rawMaterials = DOLDB<DBCraftedXItem>.SelectObjects(DB.Column("CraftedItemId_nb").IsEqualTo(recipe.Id_nb));
