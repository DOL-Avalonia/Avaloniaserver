...
namespace DOL.AI.Brain
{
	...
	public class StandardMobBrain : APlayerVicinityBrain, IOldAggressiveBrain
	{
		...
		public override void Think()
		{
			...
			{
				int distance = Vector3.Distance(Body.Position, Body.SpawnPoint);
		...
		protected virtual void CheckNPCAggro()
		{
			...
			foreach (GameNPC npc in Body.GetNPCsInRadius((ushort)AggroRange, Body.CurrentZone.IsDungeon ? false : true))
			{
