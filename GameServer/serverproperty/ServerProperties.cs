...
namespace DOL.GS.ServerProperties
{
	...
	/// <summary>
        ...
        public static bool SERVERLISTUPDATE_ENABLED { get; set; }
        ...
        public static int BAF_INITIAL_CHANCE { get; set; }
        ...
        public static int LIMIT_BAF_ADDITIONAL_CHANCE_TURRET { get; set; }
	...
	public static string BP_EXCHANGE_VALUES { get; set; }
        ...
        public static int SPELL_INTERRUPT_MAX_INTERMEDIATE_STAGELENGTH { get; set; }
        ...
        public static int GUILD_BANNER_MERIT_PRICE { get; set; }
