                    ...
                    foreach (GameObject gainer in mob.XPGainers.Keys)
                    {
                        ...
                        if (player != null)
                        {
                            foreach (LootOTD drop in lootOTDs)
                            {
                                ...
                                {
                                    CharacterXOneTimeDrop hasDrop = DOLDB<CharacterXOneTimeDrop>.SelectObject(DB.Column("CharacterID").IsEqualTo(player.QuestPlayerID).And(DB.Column("ItemTemplateID").IsEqualTo(drop.ItemTemplateID)));
                                    if (hasDrop == null)
                                    {
