 ...
 *
 * Cairbre : Adding extra features to match a specific Alfheim mob
 * 
 */
...
namespace DOL.GS
{
	public class MobHirule : GameNPC
	{
		...
		{
			//AOE Stun
			CastSpell(MobHirule.Stun, SkillBase.GetSpellLine(GlobalSpellsLines.Mob_Spells));
			//AOE Nuke
            CastSpell(MobHirule.Nuke, SkillBase.GetSpellLine(GlobalSpellsLines.Mob_Spells));
			return 0;
		}
