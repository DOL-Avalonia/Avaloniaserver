...
//				don.AddNPCEquipment((byte) eEquipmentItems.TORSO, 58, 44, 0, 0);
		...
		public override void Notify(DOLEvent e, object sender, EventArgs args)
		{
			...
			if (e == GamePlayerEvent.GiveItem)
			{
				...
				if (gArgs.Target.Name == don.Name && gArgs.Item.Id_nb == wolfPeltCloak.Id_nb)
				{
					...
					RemoveItem(don, _questPlayer, wolfPeltCloak);
			...
			else if (Step == 2 && e == GamePlayerEvent.GiveItem)
			{
				...
				{
					stewardWillie.TurnTo(_questPlayer);
					stewardWillie.SayTo(_questPlayer, "Take this token from His Lordship. If ye give it to Seamstress Lynnet in Ludlow, she'll give ye your reward. Thank ye for your fine services to His Lordship.");
		...
		public override void AbortQuest()
		{
			...
			RemoveItem(_questPlayer, wolfFur, false);
			RemoveItem(_questPlayer, wolfHeadToken, false);
		}
		...
		public override void FinishQuest()
		{
			...
			GiveItem(lynnet, _questPlayer, wolfPeltCloak);

			_questPlayer.GainExperience(GameLiving.eXPSource.Quest, 50, true);
