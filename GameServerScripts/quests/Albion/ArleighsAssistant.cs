...
namespace DOL.GS.Quests.Albion
{
    ...
    public class ArleighsAssistant : BaseQuest
    {
        ...
        public override void AbortQuest()
        {
            ...
            RemoveItem(_questPlayer, spritelingToes, false);
            RemoveItem(_questPlayer, wormRot, false);
            RemoveItem(_questPlayer, snakeSkin, false);
        }
        ...
        public override void FinishQuest()
        {
            ...
            if (dye != null)
                GiveItem(arleighPenn, _questPlayer, dye);

			_questPlayer.GainExperience(GameLiving.eXPSource.Quest, 2560, true);
