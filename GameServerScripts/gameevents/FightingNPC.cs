...
namespace DOL.GS.GameEvents
{
    ...
    public class FightingNPCEvent
    {
        ...
        public static void OnScriptsCompiled(DOLEvent e, object sender, EventArgs args)
        {
            ...
            // act each second
            m_fightTimer = new System.Timers.Timer(1000);
            m_fightTimer.AutoReset = true;
            m_fightTimer.Elapsed += new System.Timers.ElapsedEventHandler(MakeAttackSequence);
            m_fightTimer.Start();
        ...
        protected static void MakeAttackSequence(object sender, System.Timers.ElapsedEventArgs args)
        {
            GameObject attacker;
            GameObject defender;
            ushort weapon = 0x13;
